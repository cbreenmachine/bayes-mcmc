...
# ifile <- "../ModelFits/s1_CAR_result.RData"
# ofile_prefix <- "../Figures/s1_"
#

ifile <- "../ModelFits/s2_CAR_result.RData"
ofile_prefix <- "../Figures/s2_"
...
cowplot::save_plot(filename = paste0(ofile_prefix, "beta_with_ci.png"), p)
